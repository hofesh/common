...
alias gs="git status"
alias gss="git status -s | sort -k 2"
...
alias uh="/Applications/Unity\ Hub.app/Contents/MacOS/Unity\ Hub"
alias sshh="ssh 192.168.1.18"
alias open_files="sudo lsof -n | cut -f1 -d' ' | uniq -c | sort | tail -n 1000 | less"